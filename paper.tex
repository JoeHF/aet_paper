...
\begin{figure*}[!htbp]
	...
	\subfigure{
		\begin{minipage}[b]{0.1\textwidth}
			\includegraphics[width=1\textwidth]{img/aet_lru_cmp_milc.png} \\
			\includegraphics[width=1\textwidth]{img/aet_lru_cmp_mcf.png} 
		\end{minipage}
	}
	\subfigure{
		\begin{minipage}[b]{0.1\textwidth}
	...
	\subfigure{
		\begin{minipage}[b]{0.1\textwidth}
			\includegraphics[width=1\textwidth]{img/aet_lru_cmp_astar.png} \\
			\includegraphics[width=1\textwidth]{img/aet_lru_cmp_bwaves.png} 
		\end{minipage}
	}
	\subfigure{
		\begin{minipage}[b]{0.1\textwidth}
			\includegraphics[width=1\textwidth]{img/aet_lru_cmp_gcc.png} \\
			\includegraphics[width=1\textwidth]{img/aet_lru_cmp_gcc.png} 
		\end{minipage}
	}
	\subfigure{
		\begin{minipage}[b]{0.1\textwidth}
			\includegraphics[width=1\textwidth]{img/aet_lru_cmp_lbm.png} \\
			\includegraphics[width=1\textwidth]{img/aet_lru_cmp_sjeng.png} 
		\end{minipage}
	}
\end{figure*}
